...
# ✅ CORS Fix - allow both localhost & 127.0.0.1
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        "http://localhost:5176",
...
async def chat(request: ChatRequest):
    try:
        ...
        # ✅ First check custom answers with fuzzy match
        ...
        response = await client.chat.completions.create(
            ...
            messages=messages,
            temperature=0.6,
            max_tokens=500  # 2500 can be too heavy for local dev
        )
